...
test('t finds the right string', async (tap) => {
  tap.equal(t('items.batteryStorageInstallation'), "Battery Storage Installation");
  tap.equal(t('items.batteryStorageInstallation', 'en'), "Battery Storage Installation");
  tap.equal(t('items.batteryStorageInstallation', 'es'), "Instalación de baterías");
});
